...
collectGates (And g g')  = (And g g') : (collectGates g)
collectGates (Or g g')   = (Or g g') : (collectGates g)
collectGates (If g g')   = (If g g') : (collectGates g)
collectGates (Iff g g')  = (Iff g g') : (collectGates g)
collectGates (Nand g g') = (Nand g g') : (collectGates g)
collectGates (Nor g g')  = (Nor g g') : (collectGates g)
collectGates (Xor g g')  = (Xor g g') : (collectGates g)
